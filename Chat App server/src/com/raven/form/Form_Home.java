...
public class Form_Home extends javax.swing.JPanel {
   ...
   private void initTableData() throws SQLException {
    ...
    private void initCardData() {
        ...
        card1.setData(new ModelCard("Tổng Người Dùng", 5100, 20, icon1));
        ...
        card2.setData(new ModelCard("Số người Online", 2000, 60, icon2));
        ...
        card3.setData(new ModelCard("Số lượng nhóm", 3000, 80, icon3));
        Icon icon4 = IconFontSwing.buildIcon(GoogleMaterialDesignIcons.BUSINESS_CENTER, 60, new Color(255, 255, 255, 100), new Color(255, 255, 255, 15));
        card4.setData(new ModelCard("Tổng Client hạn chế", 550, 95, icon4));
    }
    ...
    private void addRefreshButtonListener() {
        btnRefresh.addActionListener(e -> {
            try {
                refreshForm(); // Reinitialize the data
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Data All Users");
